                    ...
                    @foreach($data['cartItems'] as $cartItem)
                        <div class="card rounded-3 mb-4">
                            <div class="card-body p-4">
                                <form action="/cart/product/delete/{{ $cartItem['id'] }}" method="post"
                                      class="row d-flex w-100 justify-content-end">
                                    @csrf
                                    <button onclick="return confirm('Are you sure ?')" type="submit" class="btn-close"
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                @foreach($cartItem['services'] as $service)
                                                    <div id="collapse{{ $cartItem['id'] }}"
                                                        ...
                                                        <form
                                                            action="/cart/product/{{ $cartItem['id'] }}/service/delete/{{ $service['id'] }}"
                                                            method="post">
                                                            @csrf
